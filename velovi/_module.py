...
#         self.GP_linear_decoder = MaskedLinearDecoder(in_dim=n_input_decoder,
#                                            out_dim=n_input,
...
#                                            n_ext=self.n_ext_decoder,
#                                            recon_loss=self.n_ext_m_decoder)
...
#         if batch is not None:
#             dispersion = F.linear(one_hot_encoder(batch, self.n_conditions), self.theta) #batch is the
#         else:
